...
{
    // alpha space allows letters and spaces only, along with the characters provided in the parameters
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
         ...
         *      add the provided parameters into the baseline error string -- 'The :attribute field must only contain letters and spaces, and characters ${parameters}.'
         * if no:
         *      set the regex pattern to the baseline -- /^([a-z ])*$/i
         *      set the error string to the baseline -- 'The :attribute field must only contain letters and spaces.'
         * 
        ...
        if(!empty($this->params)) // if any:
        {
            ...
            // set the regex
            $pattern = '/^([a-z ' . implode($this->params) . '])*$/i';
            
            // set the err msg
            $errorMessage = 'The :attribute field must only contain letters and spaces, and characters \'' . implode("', '", $this->params) . '\'.';
        }
        else // if none:
        {
            // set the regex
            ...
            // set the err msg
            $errorMessage = 'The :attribute field must only contain letters and spaces.';
        }
